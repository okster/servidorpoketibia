...
player1pos = {x=517, y=1127, z=7, stackpos=253}
player1 = getThingfromPos(player1pos)

player2pos = {x=516, y=1127, z=7, stackpos=253}
player2 = getThingfromPos(player2pos)

player3pos = {x=515, y=1127, z=7, stackpos=253}
player3 = getThingfromPos(player3pos)

player4pos = {x=514, y=1127, z=7, stackpos=253}
...
nplayer1pos = {x=516, y=1134, z=8}
nplayer2pos = {x=517, y=1134, z=8}
nplayer3pos = {x=517, y=1135, z=8}
nplayer4pos = {x=518, y=1133, z=8}
...
elseif item.uid ==7100 and item.itemid == 1945 then
