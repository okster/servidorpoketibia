...
local pokemons = {
{name = "Victreebel", optionalLevel = 65, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Vileplume", optionalLevel = 65, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Exeggutor", optionalLevel = 80, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Tangela", optionalLevel = 75, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Shiny Venusaur", optionalLevel = 120, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Shiny Scyther", optionalLevel = 115, sex = SEX_MALE, nick = "", ball = "normal"},
