...
local pokemons = {
{name = "Rapidash", optionalLevel = 70, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Ninetales", optionalLevel = 85, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Flareon", optionalLevel = 90, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Magmar", optionalLevel = 110, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Shiny Arcanine", optionalLevel = 110, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Shiny Charizard", optionalLevel = 110, sex = SEX_MALE, nick = "", ball = "normal"},
