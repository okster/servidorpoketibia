...
local pokemons = {
{name = "Arbok", optionalLevel = 50, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Golbat", optionalLevel = 75, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Muk", optionalLevel = 80, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Weezing", optionalLevel = 80, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Nidoqueen", optionalLevel = 150, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Shiny Nidoking", optionalLevel = 150, sex = SEX_MALE, nick = "", ball = "normal"},
}
